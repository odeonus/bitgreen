...
QT_TRANSLATE_NOOP("bitgreen-core", "The %s developers"),
...
QT_TRANSLATE_NOOP("bitgreen-core", "%d of last 100 blocks have unexpected version"),
QT_TRANSLATE_NOOP("bitgreen-core", "%s corrupt, salvage failed"),
QT_TRANSLATE_NOOP("bitgreen-core", "%s is set very high!"),
QT_TRANSLATE_NOOP("bitgreen-core", "-maxmempool must be at least %d MB"),
QT_TRANSLATE_NOOP("bitgreen-core", "Cannot downgrade wallet"),
QT_TRANSLATE_NOOP("bitgreen-core", "Cannot resolve -%s address: '%s'"),
QT_TRANSLATE_NOOP("bitgreen-core", "Cannot write to data directory '%s'; check permissions."),
QT_TRANSLATE_NOOP("bitgreen-core", "Change index out of range"),
QT_TRANSLATE_NOOP("bitgreen-core", "Config setting for %s only applied on %s network when in [%s] section."),
QT_TRANSLATE_NOOP("bitgreen-core", "Copyright (C) %i-%i"),
...
QT_TRANSLATE_NOOP("bitgreen-core", "Error loading %s"),
QT_TRANSLATE_NOOP("bitgreen-core", "Error loading %s: Private keys can only be disabled during creation"),
QT_TRANSLATE_NOOP("bitgreen-core", "Error loading %s: Wallet corrupted"),
QT_TRANSLATE_NOOP("bitgreen-core", "Error loading %s: Wallet requires newer version of %s"),
QT_TRANSLATE_NOOP("bitgreen-core", "Error loading block database"),
QT_TRANSLATE_NOOP("bitgreen-core", "Error loading wallet %s. Duplicate -wallet filename specified."),
...
QT_TRANSLATE_NOOP("bitgreen-core", "Error upgrading chainstate database"),
QT_TRANSLATE_NOOP("bitgreen-core", "Error: A fatal internal error occurred, see debug.log for details"),
...
QT_TRANSLATE_NOOP("bitgreen-core", "Invalid amount for -%s=<amount>: '%s'"),
...
QT_TRANSLATE_NOOP("bitgreen-core", "Prune cannot be configured with a negative value."),
QT_TRANSLATE_NOOP("bitgreen-core", "Prune mode is incompatible with -blockfilterindex."),
QT_TRANSLATE_NOOP("bitgreen-core", "Prune mode is incompatible with -txindex."),
QT_TRANSLATE_NOOP("bitgreen-core", "Pruning blockstore..."),
QT_TRANSLATE_NOOP("bitgreen-core", "Reducing -maxconnections from %d to %d, because of system limitations."),
QT_TRANSLATE_NOOP("bitgreen-core", "Replaying blocks..."),
QT_TRANSLATE_NOOP("bitgreen-core", "Rescanning..."),
QT_TRANSLATE_NOOP("bitgreen-core", "Rewinding blocks..."),
QT_TRANSLATE_NOOP("bitgreen-core", "Section [%s] is not recognized."),
QT_TRANSLATE_NOOP("bitgreen-core", "Signing transaction failed"),
QT_TRANSLATE_NOOP("bitgreen-core", "Specified -walletdir \"%s\" does not exist"),
QT_TRANSLATE_NOOP("bitgreen-core", "Specified -walletdir \"%s\" is a relative path"),
...
QT_TRANSLATE_NOOP("bitgreen-core", "The wallet will avoid paying less than the minimum relay fee."),
QT_TRANSLATE_NOOP("bitgreen-core", "This is experimental software."),
QT_TRANSLATE_NOOP("bitgreen-core", "This is the minimum transaction fee you pay on every transaction."),
QT_TRANSLATE_NOOP("bitgreen-core", "This is the transaction fee you will pay if you send a transaction."),
QT_TRANSLATE_NOOP("bitgreen-core", "Transaction amount too small"),
QT_TRANSLATE_NOOP("bitgreen-core", "Transaction amounts must not be negative"),
...
QT_TRANSLATE_NOOP("bitgreen-core", "Unable to create the PID file '%s': %s"),
QT_TRANSLATE_NOOP("bitgreen-core", "Unable to generate initial keys"),
QT_TRANSLATE_NOOP("bitgreen-core", "Unable to generate keys"),
QT_TRANSLATE_NOOP("bitgreen-core", "Unable to start HTTP server. See debug log for details."),
QT_TRANSLATE_NOOP("bitgreen-core", "Unknown -blockfilterindex value %s."),
QT_TRANSLATE_NOOP("bitgreen-core", "Unknown network specified in -onlynet: '%s'"),
QT_TRANSLATE_NOOP("bitgreen-core", "Unsupported logging category %s=%s."),
QT_TRANSLATE_NOOP("bitgreen-core", "Upgrading UTXO database"),
QT_TRANSLATE_NOOP("bitgreen-core", "Upgrading txindex database"),
QT_TRANSLATE_NOOP("bitgreen-core", "User Agent comment (%s) contains unsafe characters."),
